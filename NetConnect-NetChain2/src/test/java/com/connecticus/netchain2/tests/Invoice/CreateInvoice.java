package com.connecticus.netchain2.tests.Invoice;
...
public class CreateInvoice {
	...
	public void verifyInvoiceCreatedInList() {
	 ...
	 @TestDetails(author="", description="")
	 //@Test(groups= {"Regression"},dependsOnMethods= {"testCreateInvoice"})
	 public void testXYZ() {
		 
	 }
	 
	 @TestDetails(author="", description="")
	 //@Test(groups= {"Sanity"},dependsOnMethods= {"testXYZ"})
	 public void testXYZ1() {
