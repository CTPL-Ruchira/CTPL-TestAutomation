...
public class CreateSalesOrder extends BaseTestCase {
	...
	public void salesOrderCreation() {
		...
		boolean isAmountRoundedForFirstLine=pocf.verifyTotalAmountCalculatedAndShown(PurchaseOrderCreationForm.getPreviousAmount());
		...
		boolean isAmountRoundedForSecondLine=pocf.verifyTotalAmountCalculatedAndShown(PurchaseOrderCreationForm.getPreviousAmount());
		...
		boolean isAmountRoundedForThirdLine=pocf.verifyTotalAmountCalculatedAndShown(PurchaseOrderCreationForm.getPreviousAmount());
		...
		//
		//Common.sleep(3000);
		//System.out.println("So Num"+SOCreation);
		//CommonMethods.searchByNumberOrName(SOCreation.getSoNumber());
