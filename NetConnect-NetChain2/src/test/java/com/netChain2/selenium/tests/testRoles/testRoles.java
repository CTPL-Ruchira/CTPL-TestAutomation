...
public class testRoles extends BaseTestCase 
{
   ...
   public void verifyActionApprovePayment() 
   {
	   ...
	   //ica.searchInvoice(getInvoiceId);
	    ...
	    //Verification for view payment
	    role.clickOnViewPayment(setRolesWorkFlow.get(8), getInvoiceId);
	    
	    //Get Payment Id
	    String payId=customWorkFlowSet.getPaymentId();
	   ...
	   //Verification for action payment pending
	   role.verificationForApprovalPending(setRolesWorkFlow.get(8), payId,setRolesWorkFlow.get(24));
