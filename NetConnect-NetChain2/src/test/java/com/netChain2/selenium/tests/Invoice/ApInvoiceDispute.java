...
public class ApInvoiceDispute extends BaseTestCase
{
	...
	@Test(dependsOnMethods= {"login"})
	 public void testCreateInvoice() {
		System.out.println("Into testCreateInvoice");
			...
			purchaseOrder.setItemDetails(invoiceTestData.get(6),invoiceTestData.get(7),invoiceTestData.get(8),invoiceTestData.get(9), invoiceTestData.get(11), invoiceTestData.get(12));
	...
	public void performDispute()
	{
		...
		boolean isRateCorrectOnInvoicePreview=id.verifyValuesAfterSendingDisputeInInVoicePreviewPage(id.getRateFromProductLineInInvoicePreviewPage(invoiceTestData.get(6)), "$142.99");
