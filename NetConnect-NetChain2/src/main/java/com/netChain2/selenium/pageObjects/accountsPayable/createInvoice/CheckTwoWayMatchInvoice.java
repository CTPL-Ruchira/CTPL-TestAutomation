...
public class CheckTwoWayMatchInvoice {
	...
	//select vendor name from dropdown in invoice page 
		...
		public void invoiceCreation(String vendorName,String netTerm, String locationName, String productName, String departmentName, String bookingAccount) 
		{	
			selectVendor(vendorName);
			Common.sleep(4000);

			selectNetTerm(netTerm);

			//Select Location
			selectLocation(locationName);

			selectProduct_Invoice(productName);

			selectDepartment_Invoice(departmentName);

			selectBookingAccount_Invoice(bookingAccount);
